...
#line 90 "Cooklang.tab.c" /* yacc.c:337  */
# ifndef YY_NULLPTR
...
union YYSTYPE
{
#line 25 "Cooklang.y" /* yacc.c:352  */

  char * string;
  char character;
  double number;

#line 154 "Cooklang.tab.c" /* yacc.c:352  */
};
...
{
       0,    48,    48,    49,    54,    55,    63,    72,    76,    86,
      91,    92,    93,    94,   101,   113,   114,   115,   120,   125,
     131,   137,   143,   153,   158,   164,   170,   174,   180,   184,
     193,   198,   202,   208,   214,   220,   229,   238,   245,   255,
     269,   275,   282,   292,   305,   310,   315,   322
};
#endif
...
static const char *const yytname[] =
{
  ...
  "METADATA", "$accept", "input", "line", "step", "direction", "text_item",
  "amount", "cookware_amount", "cookware", "ingredient", "timer", YY_NULLPTR
};
#endif
...
{
     -11,     2,   -11,   -11,   -11,   -11,   -11,   -11,     0,    28,
      35,    -9,   -11,    17,   -11,    42,   -11,   -11,   -11,    10,
      10,    46,   -11,    26,    29,    52,    42,   -11,    10,    10,
      42,   -11,   -11,   -11,   -11,   -11,   -11,   -11,   -11,   -11,
     -11,    66,    68,    70,   -11,    58,   -11,    64,   -11,    14,
      32,    39,   -11,   -11,   -11,    45,   -11,    49,   -11,    51,
...
static const yytype_uint8 yytable[] =
{
      ...
      10,    23,    24,    45,     5,    25,    47,     6,    28,    29,
      64,     5,    21,    34,     6,    35,    36,    65,    37,    41,
      42,    38,    43,    66,    44,    49,    50,    67,    51,    68,
      52,    49,    50,     0,    51,     0,    61,    49,    50,     0,
      51,    55,    62,    57,    56,    59,    58,     0,    60,    46,
      48
};
...
static const yytype_int8 yycheck[] =
{
      ...
      13,     3,     4,     7,     6,     7,     7,     9,     3,     4,
       8,     6,     7,    13,     9,     3,     4,     8,     6,     3,
       4,     9,     6,     8,     8,     3,     4,     8,     6,     8,
       8,     3,     4,    -1,     6,    -1,     8,     3,     4,    -1,
       6,     5,     8,     5,     8,     5,     8,    -1,     8,    23,
      24
};
...
{
       0,    16,     0,     3,     4,     6,     9,    10,    11,    12,
      13,    14,    17,    18,    19,    20,    23,    24,    25,     3,
       4,     7,    21,     3,     4,     7,    20,    22,     3,     4,
      20,    21,    10,    10,    19,     3,     4,     6,     9,    21,
      21,     3,     4,     6,     8,     7,    22,     7,    22,     3,
       4,     6,     8,    21,    21,     5,     8,     5,     8,     5,
       8,     8,     8,     8,     8,     8,     8,     8,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 54 "Cooklang.y" /* yacc.c:1652  */
    {}
#line 1288 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 5:
#line 55 "Cooklang.y" /* yacc.c:1652  */
    {
...
#line 1301 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 6:
#line 63 "Cooklang.y" /* yacc.c:1652  */
    {
      // add metadata to the recipe
      addMetaData(recipe, (yyvsp[-1].string));
      free((yyvsp[-1].string));
    }
#line 1311 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 7:
#line 72 "Cooklang.y" /* yacc.c:1652  */
    {
        (yyval.string) = strdup((yyvsp[0].string));
        free((yyvsp[0].string));
      }
#line 1320 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 8:
#line 76 "Cooklang.y" /* yacc.c:1652  */
    {
...
#line 1331 "Cooklang.tab.c" /* yacc.c:1652  */
  ...
  case 9:
#line 86 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = strdup((yyvsp[0].string));
      addDirection(recipe, "TextItem", (yyvsp[0].string), NULL);
      free((yyvsp[0].string));
    }
#line 1341 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 13:
#line 94 "Cooklang.y" /* yacc.c:1652  */
    {
...
#line 1353 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 14:
#line 101 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = addTwoStrings((yyvsp[-1].string), (yyvsp[0].string));
...
#line 1365 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 17:
#line 115 "Cooklang.y" /* yacc.c:1652  */
    { 
      (yyval.string) = malloc(10);
      sprintf((yyval.string), "%.3f", (yyvsp[0].number));
    }
#line 1374 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 18:
#line 120 "Cooklang.y" /* yacc.c:1652  */
    { 
      (yyval.string) = malloc(5);
      sprintf((yyval.string), "%c", (yyvsp[0].character));
    }
#line 1383 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 19:
#line 125 "Cooklang.y" /* yacc.c:1652  */
    { 
      (yyval.string) = addTwoStrings((yyvsp[-1].string), (yyvsp[0].string));
      free((yyvsp[-1].string));
      free((yyvsp[0].string));
    }
#line 1393 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 20:
#line 131 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = addTwoStrings((yyvsp[-1].string), (yyvsp[0].string));
      free((yyvsp[-1].string));
      free((yyvsp[0].string));
...
#line 1413 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 22:
#line 143 "Cooklang.y" /* yacc.c:1652  */
    { 
      (yyval.string) = malloc(strlen((yyvsp[-1].string)) + 5);
      sprintf((yyval.string), "%s %c", (yyvsp[-1].string), (yyvsp[0].character));
      free((yyvsp[-1].string));
    }
#line 1423 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 23:
#line 153 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = malloc(5);
...
#line 1432 "Cooklang.tab.c" /* yacc.c:1652  */
  ...
  case 24:
#line 158 "Cooklang.y" /* yacc.c:1652  */
    { 
...
#line 1442 "Cooklang.tab.c" /* yacc.c:1652  */
  ...
  case 25:
#line 164 "Cooklang.y" /* yacc.c:1652  */
    { 
...
#line 1460 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1478 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 29:
#line 184 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = addTwoStrings((yyvsp[-2].string), (yyvsp[-1].string));
      free((yyvsp[-2].string));
      free((yyvsp[-1].string));
    }
#line 1488 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 30:
#line 193 "Cooklang.y" /* yacc.c:1652  */
    {
        (yyval.string) = malloc(100);
        sprintf((yyval.string), "%.3f", (yyvsp[-1].number));
      }
#line 1497 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1505 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 32:
#line 202 "Cooklang.y" /* yacc.c:1652  */
    {
        (yyval.string) = (yyvsp[-1].string);
    }
#line 1513 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 33:
#line 208 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = strdup((yyvsp[0].string));
      addDirection(recipe, "Cookware", (yyvsp[0].string), NULL);
      free((yyvsp[0].string));
    }
#line 1523 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1533 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 35:
#line 220 "Cooklang.y" /* yacc.c:1652  */
    { 
...
#line 1546 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1559 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 37:
#line 238 "Cooklang.y" /* yacc.c:1652  */
    { 
      (yyval.string) = addTwoStrings((yyvsp[-1].string), (yyvsp[0].string));
...
#line 1570 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1584 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 39:
#line 255 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = addThreeStrings((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].string));
      char * valueString = addTwoStrings((yyvsp[-2].string), (yyvsp[-1].string));
      addDirection(recipe, "Cookware", valueString, (yyvsp[0].string));
...
#line 1598 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 40:
#line 269 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = strdup((yyvsp[0].string));
      addDirection(recipe, "Ingredient", (yyvsp[0].string), NULL);
      free((yyvsp[0].string));
    }
#line 1608 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 41:
#line 275 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = addTwoStrings((yyvsp[-1].string), (yyvsp[0].string));
...
#line 1619 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1633 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 43:
#line 292 "Cooklang.y" /* yacc.c:1652  */
    {
      (yyval.string) = addThreeStrings((yyvsp[-2].string), (yyvsp[-1].string), (yyvsp[0].string));
      char * valueString = addTwoStrings((yyvsp[-2].string), (yyvsp[-1].string));
      addDirection(recipe, "Ingredient", valueString, (yyvsp[0].string));
...
#line 1647 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 44:
#line 305 "Cooklang.y" /* yacc.c:1652  */
    {
        (yyval.string) = strdup((yyvsp[0].string));
        addDirection(recipe, "Timer", NULL, (yyvsp[0].string));
        free((yyvsp[0].string));
      }
#line 1657 "Cooklang.tab.c" /* yacc.c:1652  */
    break;

  case 45:
#line 310 "Cooklang.y" /* yacc.c:1652  */
    {
        (yyval.string) = strdup((yyvsp[0].string));
...
#line 1667 "Cooklang.tab.c" /* yacc.c:1652  */
  ...
  case 46:
#line 315 "Cooklang.y" /* yacc.c:1652  */
    { 
        (yyval.string) = addTwoStrings((yyvsp[-1].string), (yyvsp[0].string));
...
#line 1678 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 1689 "Cooklang.tab.c" /* yacc.c:1652  */
    break;
...
#line 331 "Cooklang.y" /* yacc.c:1918  */
